...
def main() -> None:
    ...
    print("learn applied:", learned["applied"], "abstained:", learned["abstained"])
    print("what_have_i_learned:", engine.what_have_i_learned("coffee")["answer"])
    ...
    print("learning:", sketch.get("learning"))
    print("offline:", sketch.get("offline"))
    ...
    print("learning_metrics:", snap["learning"])
    print("offline_metrics:", snap["offline"])
    sleep = engine.sleep()
    print("sleep:", sleep)

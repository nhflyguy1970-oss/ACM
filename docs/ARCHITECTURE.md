...
**Mode:** Implementation authorized in the standalone ACM repository; this document remains the architectural north star. Host migration (Aria, etc.) is **not** authorized by architecture alone.  
...
**Approved as ACM canonical Cognitive Memory architecture (v2.1).**

...
**Status:** Constitutional — canonical cognitive truths for ACM  
...
| [`LEARNING_ARCHITECTURE.md`](LEARNING_ARCHITECTURE.md) | Learning organ (M7) |
| [`OFFLINE_COGNITION.md`](OFFLINE_COGNITION.md) | Offline Cognition / Sleep (M8) |

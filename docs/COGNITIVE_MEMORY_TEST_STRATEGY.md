...
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | Architecture — *how* |
...
- Not a new cognitive subsystem in production consumers  
- Not a replacement for host observability adapters (it *feeds* them)  
...
Host conversation/trace and Host observability UI remain first-class. They evolve from **execution telemetry** toward **cognitive behavior telemetry**—without exposing reasoning internals.

### 4.1 Host conversation/trace — cognitive behavior record
...
### 4.2 Host observability UI — cognitive visualization (eventual)
...
5. **Compatibility** — Behavioral Compatibility · Host conversation/trace · Host observability UI green.  

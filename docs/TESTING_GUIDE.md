...
- [ ] `validation.snapshot()` contains schema `acm.validation/0.6`
...
- [ ] Concept harness metrics present (`acm.validation/0.6`)
...
- [ ] Association harness metrics present (`acm.validation/0.6`)
...
- [ ] Remembering harness metrics present (`acm.validation/0.6`)
